...
set.seed(0)
inp <-
  "~/new_NUM_CODEX_PLUS/Amina/CellSubmission/new_runs/output_TOP10/merged_training/pseudo_bulk.h5Seurat"
ch <- LoadH5Seurat(inp)
...
pdf(
  file = paste0(
    "~/new_NUM_CODEX_PLUS/Amina/CellSubmission/new_runs/figures/cpm_all.pdf"
  ),
...
pdf(
  file = paste0(
    "~/new_NUM_CODEX_PLUS/Amina/CellSubmission/new_runs/figures/edgeR_all.pdf"
  ),
  # The directory you want to save the file in
  width = 10,
  # The width of the plot in inches
...
pdf(
  file = paste0(
    "~/new_NUM_CODEX_PLUS/Amina/CellSubmission/new_runs/figures/DEG_all.pdf"
  ),
  # The directory you want to save the file in
  width = 15,
  # The width of the plot in inches
