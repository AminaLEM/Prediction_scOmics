...
if __name__ == "__main__":
    ...
    y_score1_LReg=predict_loop(LReg_j,np.concatenate((x_exp,x_cell), axis=1))
    y_score2_LReg=predict_loop(LReg_e,x_exp)
    y_score3_LReg=predict_loop(LReg_c,x_cell)
...
#         plt.show()
    ...
    shap_values_all_exp,shap_values_all_cell=shap_loop(list(model_j), training_set,dim_exp, dim_cells,x_exp,x_cell)
